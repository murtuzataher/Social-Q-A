...
<head>
<title>Users Same Interest</title>
...
<div class="main style2">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
	  <h2><span class="style6">All Users With Same Interest</span></h2>
	  <table width="600" border="3"  cellpadding="0" cellspacing="0"  style="border-collapse: collapse; margin:10px 10px 10px 10px; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:14px;">
					<tr bgcolor="#993366">
					  ...
					  <td  width="100" height="31" align="center" valign="baseline" style="color: #2c83b0;"><div align="center"><b>Interest In</b></div></td>
					</tr>
...
<%@ include file="connect.jsp" %>
					<%String uname=(String )application.getAttribute("uname");
						...
						try 
						{
						   		...
						   		String sql="select * from interests where username='"+uname+"' ";
								...
								String sql1="select * from interests where username!='"+uname+"' and category='"+s1+"' ";
								Statement st1=connection.createStatement();
								ResultSet rs1=st1.executeQuery(sql1);
					   			while( rs1.next() )
								{
								String s2=rs1.getString(1);
								String s3=rs1.getString(2);
					...
					<tr bgcolor="#FFFFFF">
				        ...
				        <a href="U_UserProfile.jsp?user=<%=s2%>&type=<%="user4"%>"> <%out.println(s2);%></a>
					  </span></td>
					...
					if(count==0){out.print("No User have Same Interest As Your Interest");}
