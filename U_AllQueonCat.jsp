...
<div class="main style2">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
	  <h2><span class="style7">All User Questions</span></h2>
	  ...
	  <table width="500" height="70" border="3"  cellpadding="0" cellspacing="0"  style="border-collapse: collapse;  margin:10px 10px 10px 10px; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:14px;">
					<tr bgcolor="#990033">
					  ...
					  <td  width="105" height="0" valign="baseline" style="color: #2c83b0;"><div align="center"><b>Category</b></div></td>
	  ...
	  <%
	  	...
	  	String quser="",qcategory="",question="",qdate="",qqueue="";
        ...
        ResultSet rs=st.executeQuery(query);
			while ( rs.next()==true )
				...
				<tr bgcolor="#FFFFFF">
			      ...
			      <%=qid%>		          </div></td>	
								<td  width="139" height="60" valign="middle">
						          <div align="center" class="style6">
	             <a href="U_UserProfile.jsp?user=<%=quser%>&type=<%="user2"%>"> <%=quser%> </a>   </div></td>
		          ...
		          <%=decryptedDes%>?</div></td>
							  ...
							  <td  width="114" height="60" valign="middle">
							      <div align="center">
		          <a href="U_GiveAnswer.jsp?qname=<%=quser%>&quid=<%=quid%>&qcat=<%=qcategory%>&qdate=<%=qdate%>&question=<%=question%>&qid=<%=id%>&type=<%="all"%>">Give Answer</a>		          </div></td>
							 <%}
							 else
							 {
							%> <td  width="114" height="60" valign="middle">
							      <div align="center" class="style8">
				<a href="U_AllAnswered.jsp?quest=<%=question%>&type=<%="AllQues"%>">Answered</a></div></td>
							 <%
							 }
							 %>
		  </tr>
				...
				if(count==0){out.print("There Is No Questions To Answer");}
