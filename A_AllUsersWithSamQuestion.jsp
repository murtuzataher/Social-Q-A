...
<head>
<title>Admin All Users With Same Questions</title>
...
<div class="main style2">
  ...
  <div class="content">
    <div class="content_resize">
	  ...
	  <h2>All Users With Same Question...</h2>
         <%    
		 int id=0,count=0;
           	    String query="select distinct question from samequestions "; 
	       ...
	       <table width="572" border="1">
				  <tr bgcolor="#FFFFFF">
				    <td colspan="5" bgcolor="#FFFFFF" ><h2 class="style10">Question On: <span class="style11"><%=decryptedDes%>?</span></h2></td>
			      </tr>
				  <tr>
				  ...
				  <%
				  id=0;
			 String sql3="select distinct qusername from samequestions where question='"+s1+"' ";
				...
				String s2=rs3.getString(1);
							id++;	count++;     
							  ...
							  <tr>
								...
								<td width="174" height="0" bgcolor="#FFFFFF"  style="color:#000000;"><div align="center" class="style11"><a href="A_UserProfile.jsp?user=<%=s2%>&type=<%="admin7"%>"><%=s2%></a></div></td>
							  </tr>
	       ...
	       <p>&nbsp;</p><%
			...
			if(count==0){out.print("No Your with same interest Question found");}
