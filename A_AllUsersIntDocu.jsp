...
<head>
<title>Admin All USers Interested Documents</title>
...
<div class="main style2">
  ...
  <div class="content">
    <div class="content_resize">
	  ...
	  <h2><span class="style9">All</span> Users Documents...</h2>
         <%    
		 int id=0,count=0;
			%>
	       <table width="572" border="1">
				  ...
				  <%
				  id=0;
			 String sql3="select * from document order by category ";
			...
			while ( rs3.next() )
			   {
				...
				String decryptedDes= new String(Base64.decode(s5.getBytes()));
							...
							<td width="128" height="0" bgcolor="#FFFFFF"  style="color:#000000;"><div align="center" class="style11"><%=id%></div></td>
								<td width="174" height="0" bgcolor="#FFFFFF"  style="color:#000000;"><div align="center" class="style11"><a href="A_UserProfile.jsp?user=<%=s2%>&type=<%="admin1"%>"><%=s2%></a></div></td>
					 ...
					 if(count==0){out.print("No Documents Have Uploaded");}
					 %></table>
	       <p>&nbsp;</p>
