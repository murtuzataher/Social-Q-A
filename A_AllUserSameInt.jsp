...
<div class="main style2">
  ...
  <div class="content">
    <div class="content_resize">
	  ...
	  <h2>All Users With Same Interest...</h2>
         <%    
		 int id=0;
	       ...
	       <table width="572" border="1">
				  <tr bgcolor="#FFFFFF">
				    <td colspan="5" bgcolor="#FFFFFF" ><h2 class="style10">Interest In: <span class="style11"><%=s1%></span></h2></td>
			      </tr>
				  <tr>
					...
					<td width="174" bgcolor="#FFFFFF" ><div align="left" class="style5 style7 style8">
						<div align="center"> User Description</div>
					</div></td>
				  </tr>
				 
				  <%
				  id=0;
			 String sql3="select * from interests where category='"+s1+"' ";
			 Statement st3=connection.createStatement();
			 ResultSet rs3=st3.executeQuery(sql3);
			while ( rs3.next() )
			   {
				String s2=rs3.getString(1);
				String descr=rs3.getString(3);
							id++;	     
									 %>
							  <tr>
								...
								<td width="128" height="0" bgcolor="#FFFFFF"  style="color:#000000;"><div align="center" class="style11"><%=descr%></div></td>
							  </tr>
